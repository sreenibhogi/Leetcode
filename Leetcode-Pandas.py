...
To select multiple columns , we need to use [[]] with Dataframe name
In Pandas OR condition is used with |
Use the dataframe name "World" before the brackets ['column'] 
"""
